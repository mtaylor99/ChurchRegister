...
public class ChurchMember : IAuditableEntity
{
    ...
    // Foreign Keys
    public int? ChurchMemberTypeId { get; set; }
    ...
    public virtual ChurchMemberType? ChurchMemberType { get; set; }
    ...
    public virtual ICollection<ChurchMemberDataProtection> DataProtection { get; set; } = new List<ChurchMemberDataProtection>();
