...
namespace ChurchRegister.Database.Data
{
    public class ChurchRegisterWebContext(DbContextOptions<ChurchRegisterWebContext> options) : IdentityDbContext<ChurchRegisterWebUser>(options)
    {
        ...
        public DbSet<HSBCExcludedReference> HSBCExcludedReferences { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            ConfigureHsbcExcludedReferences(modelBuilder);
        ...
        private void ConfigureChurchMember(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ChurchMember>(entity =>
            {
                ...
                entity.Property(e => e.Baptised).IsRequired().HasDefaultValue(false);
                entity.Property(e => e.GiftAid).IsRequired().HasDefaultValue(false);
                entity.Property(e => e.PastoralCareRequired).IsRequired().HasDefaultValue(false);
                
                // Non-unique index for BankReference (allows up to 2 members to share - for couples)
                entity.HasIndex(e => e.BankReference)
                    .HasDatabaseName("IX_ChurchMembers_BankReference")
        ...
        private void ConfigureContributions(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<ChurchMemberContributions>(entity =>
            {
                ...
                entity.Property(e => e.ManualContribution).IsRequired().HasDefaultValue(false);
                ...
                // Non-unique index for HSBCBankCreditTransactionId (allows shared bank references - 2 contributions per transaction)
                entity.HasIndex(e => e.HSBCBankCreditTransactionId)
                    .HasDatabaseName("IX_ChurchMemberContributions_HSBCTransactionId")
        ...
        private void ConfigureHsbcExcludedReferences(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<HSBCExcludedReference>(entity =>
            {
                entity.HasKey(e => e.Id);
                ...
                // Unique index — one exclusion entry per reference string
                entity.HasIndex(e => e.Reference)
                    .IsUnique()
                    .HasDatabaseName("IX_HSBCExcludedReferences_Reference_Unique");
            });
        }
        ...
        private void ConfigureReminders(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ReminderCategory>(entity =>
            {
                ...
                entity.Property(e => e.IsSystemCategory).IsRequired().HasDefaultValue(false);
        ...
        private void ConfigureSeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<ChurchMemberStatus>().HasData(
                ...
                new ChurchMemberStatus { Id = 5, Name = "Transferred", CreatedBy = "system", CreatedDateTime = seedDateTime }
            );
            ...
            modelBuilder.Entity<Districts>().HasData(
                ...
                new Districts { Id = 13, Name = "M", CreatedBy = "system", CreatedDateTime = seedDateTime }
            );
