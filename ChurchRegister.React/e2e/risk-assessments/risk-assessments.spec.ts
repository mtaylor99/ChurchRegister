 ...
 * - Export button is present on the Risk Assessments tab
 *
...
test.describe('Risk Assessments', () => {
  ...
  test('Add Risk Assessment opens a drawer with form fields', async ({
    ...
    await page.getByRole('button', { name: /Add Risk Assessment/i }).click();
  ...
  test('Export button is visible on the Risk Assessments tab', async ({
    page,
  }) => {
    // Export button is on the Risk Assessments tab toolbar
