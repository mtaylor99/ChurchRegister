...
export const RiskAssessmentWidget: React.FC = () => {
  ...
  // Status icon (only shown for overdue/due-soon states)
  const StatusIcon = isOverdue ? ErrorIcon : WarningIcon;
      ...
      >
        <CardContent sx={{ p: 3 }}>
          ...
          >
            ...
            >
              {(isOverdue || isDueSoon) && <StatusIcon sx={{ fontSize: 20 }} />}
              <Typography variant="body2" fontWeight="medium">
                {isOverdue ? 'Overdue' : isDueSoon ? 'Due Soon' : 'All Clear'}
              </Typography>
            </Box>
          </Box>
          ...
          {isOverdue || isDueSoon ? (
            ...
            <>
              ...
              <Typography variant="caption" color="text.secondary">
                {totalCount} {totalCount === 1 ? 'assessment' : 'assessments'}{' '}
                up to date
              </Typography>
            </>
          )}
