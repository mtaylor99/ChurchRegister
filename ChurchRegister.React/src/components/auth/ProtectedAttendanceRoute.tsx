...
export interface ProtectedAttendanceRouteProps {
...
/**
 * Protected route component that requires specific attendance permissions
 * Redirects unauthorized users to appropriate error pages
 */
export const ProtectedAttendanceRoute: React.FC<
  ProtectedAttendanceRouteProps
...
export default ProtectedAttendanceRoute;
