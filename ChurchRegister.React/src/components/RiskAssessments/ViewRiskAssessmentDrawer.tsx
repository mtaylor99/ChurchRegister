...
export interface ViewRiskAssessmentDrawerProps {
  open: boolean;
  onClose: () => void;
              ...
              <Stack spacing={1}>
                ...
                <Box>
                  ...
                  <Typography variant="body2">
                    {riskAssessment.lastReviewDate
                      ? format(
                          new Date(riskAssessment.lastReviewDate),
                          'dd MMM yyyy'
                        )
                      : 'Never Reviewed'}
                  </Typography>
                ...
                <Box>
                  ...
                  <Stack direction="row" alignItems="center">
                    ...
                    <Typography variant="body2">
                      {format(
                        new Date(riskAssessment.nextReviewDate),
                        'dd MMM yyyy'
                      )}
                    </Typography>
                  </Stack>
                ...
                <List dense>
                  {riskAssessment.approvals.map((approval) => (
                    <ListItem key={approval.id} divider>
                      <ListItemAvatar>
                        <Avatar>
                          {approval.approvedByMemberName.charAt(0)}
                        </Avatar>
                      </ListItemAvatar>
                      <ListItemText
