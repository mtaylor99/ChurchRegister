...
export interface ViewHistoryDrawerProps {
  open: boolean;
  onClose: () => void;
...
export const ViewHistoryDrawer: React.FC<ViewHistoryDrawerProps> = ({
  ...
  const {
    ...
    isPending,
    isError,
  } = useAssessmentHistory(riskAssessmentId);
      ...
      <Box sx={{ height: '100%', display: 'flex', flexDirection: 'column' }}>
        ...
        <Box sx={{ flex: 1, overflow: 'auto', p: 3 }}>
          ...
          {history && history.reviewCycles.length === 0 && (
            <Alert severity="info">
              No version history available yet. History will be recorded once
                  ...
                  <Box key={cycleIndex} sx={{ mb: 4 }}>
                    ...
                    <Box
                      sx={{
                        ...
                        borderBottom: 2,
                        borderColor:
                          cycleIndex === 0 ? 'primary.main' : 'divider',
                      }}
                    >
                    ...
                    {cycle.approvals.length === 0 ? (
                      ...
                      <List disablePadding>
                        {(() => {
                          ...
                          const groupedApprovals = cycle.approvals.reduce(
                            (acc, approval) => {
                          ...
                          return Object.values(groupedApprovals).map(
                            (group, groupIndex) => (
                              <Card
