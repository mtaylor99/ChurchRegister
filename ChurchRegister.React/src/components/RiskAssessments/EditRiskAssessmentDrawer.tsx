...
export interface EditRiskAssessmentDrawerProps {
  open: boolean;
  onClose: () => void;
...
export function EditRiskAssessmentDrawer({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      setError(extractErrorMessage(err, 'Failed to update risk assessment'));
    }
  };
        ...
        <Stack spacing={3}>
          ...
          <FormControl fullWidth required>
            ...
            <Select
              ...
              onChange={(e) =>
                setReviewInterval(Number(e.target.value) as 1 | 2 | 3 | 5)
              }
