...
export const AddChurchMemberForm: React.FC<AddChurchMemberFormProps> = ({
  ...
  const createMemberMutation = useMutation({
    ...
    onError: (error: unknown) => {
      // ApiClient shows toast for 409 Conflict errors (e.g., bank reference at capacity)
      // For 400 validation errors, set inline error for form feedback
              ...
              render={({ field }) => {
                ...
                return (
                  ...
                  >
                    ...
                    {!errors.roleIds && (
                      <FormHelperText>
                        Select whether this person is a Member or Non-Member,
                        then assign any additional roles.
                      </FormHelperText>
                    )}
                  </Box>
                );
