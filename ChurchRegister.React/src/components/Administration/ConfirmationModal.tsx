...
> = ({ onGenerationSuccess }) => {
  ...
  const handleConfirmGeneration = async () => {
    ...
    try {
      ...
      setSuccessMessage(
        `Successfully generated ${result.totalMembersAssigned} Member numbers and ${result.totalNonMembersAssigned} Non-Member numbers for ${result.year}`
      );
  ...
  return (
    <>
          ...
          {alreadyGenerated ? (
            ...
            <>
              <Alert severity="info" sx={{ mb: 2 }}>
                ...
                members. Members receive numbers starting at 1; Non-Members
                receive numbers starting at 250. This action cannot be undone.
              </Alert>
        ...
        <DialogTitle>
          <Box display="flex" alignItems="center" gap={1} flexWrap="wrap">
            ...
            {previewData && (
              <>
                <Chip
                  label={`${previewData.totalMembers} Members`}
                  color="primary"
                  size="small"
                />
                <Chip
            ...
            <Box sx={{ display: 'flex', flexDirection: 'column', gap: 3 }}>
              ...
              <Box>
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  Members — Numbers 1 to {previewData.totalMembers}
                </Typography>
              ...
              <Box>
                <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                  Non-Members — Numbers 250 to{' '}
                  {249 + previewData.totalNonMembers}
                </Typography>
                <TableContainer component={Paper} variant="outlined">
                  <Table size="small">
                    <TableHead>
      ...
      <ConfirmationModal
        ...
        message={`Are you sure you want to generate membership numbers for ${targetYear}? This will assign numbers to ${previewData?.totalMembers ?? 0} Members (starting at 1) and ${previewData?.totalNonMembers ?? 0} Non-Members (starting at 250). This action cannot be undone.`}
