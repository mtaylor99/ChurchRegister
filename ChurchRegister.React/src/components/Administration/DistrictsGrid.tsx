...
import { AssignDescriptionDialog } from './AssignDescriptionDialog';
  ...
  return (
    <Box>
      ...
      >
        ...
        <MenuItem onClick={handleAssignDescription}>
          <ListItemIcon>
            <NotesIcon fontSize="small" />
          </ListItemIcon>
          <ListItemText>Assign Description</ListItemText>
        </MenuItem>
      </Menu>
