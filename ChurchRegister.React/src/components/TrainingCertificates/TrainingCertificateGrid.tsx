...
export const TrainingCertificateGrid: React.FC<TrainingCertificateGridProps> =
  React.memo(
    ({
      onEditCertificate,
      onViewCertificate,
      ...
      const [searchQuery, setSearchQuery] =
        useState<TrainingCertificateGridQuery>({
          ...
          status:
            ...
            (showExpired
              ? undefined
              : `!${TRAINING_CERTIFICATE_STATUSES.EXPIRED}`),
      ...
      const { data: certificatesResponse, isLoading } = useQuery({
        ...
        queryFn: () =>
          trainingCertificatesApi.getTrainingCertificates(searchQuery),
        ...
        <Box sx={{ height: '100%', width: '100%' }}>
              ...
              <Stack direction={{ xs: 'column', sm: 'row' }} spacing={2}>
                ...
                <FormControl size="small" sx={{ minWidth: 200 }}>
                  ...
                  <Select
                    value={typeFilter || ''}
                    onChange={(e) =>
                      setTypeFilter(Number(e.target.value) || undefined)
                    }
                    label="Training Type"
                  >
                    <MenuItem value="">
                ...
                <FormControl size="small" sx={{ minWidth: 150 }}>
                  ...
                  >
                    ...
                    <MenuItem
                      value={TRAINING_CERTIFICATE_STATUSES.ALLOW_TO_EXPIRE}
                    >
                      Allow to Expire
                    </MenuItem>
                  </Select>
          ...
          >
            ...
            <MenuItem
              onClick={() =>
                selectedCertificate &&
                handleEditCertificate(selectedCertificate)
              }
            >
              <ListItemIcon>
