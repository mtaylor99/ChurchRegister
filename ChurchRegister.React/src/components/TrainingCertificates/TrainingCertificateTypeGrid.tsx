...
export interface TrainingCertificateTypeGridHandle {
  openAddDialog: () => void;
}

export const TrainingCertificateTypeGrid = React.memo(
  forwardRef<TrainingCertificateTypeGridHandle, TrainingCertificateTypeGridProps>(
    ({ onTypeUpdated }, ref) => {
    // Action menu state
          ...
          >
            ...
            <FormControl size="small" sx={{ minWidth: 200 }}>
              ...
              >
                ...
                <MenuItem value={TRAINING_TYPE_STATUSES.ACTIVE}>
                  Active
                </MenuItem>
