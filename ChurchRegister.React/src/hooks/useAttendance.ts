...
import { attendanceKeys } from '../utils/queryKeys';
...
export function useCreateAttendance() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to create attendance record'),
        'error'
      );
    },
  });
...
export function useUpdateAttendance() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to update attendance record'),
        'error'
      );
    },
  });
...
export function useDeleteAttendance() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to delete attendance record'),
        'error'
      );
    },
  });
...
export function useCreateEvent() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to create event'),
        'error'
      );
    },
  });
...
export function useUpdateEvent() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to update event'),
        'error'
      );
    },
  });
...
export function useEmailEventAnalytics() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to send analytics email'),
        'error'
      );
    },
  });
...
export function useEmailAllEventsAnalytics() {
  ...
  return useMutation({
    ...
    onError: (error: unknown) => {
      showNotification(
        extractErrorMessage(error, 'Failed to send all events analytics email'),
        'error'
      );
    },
  });
