...
describe('useRBAC', () => {
  ...
  describe('hasAnyRole', () => {
    test('should return true if user has any of the specified roles', () => {
      ...
      expect(
        result.current.hasAnyRole(['Administrator', 'Officer', 'Trustee'])
      ).toBe(true);
    });
  ...
  describe('permission checks', () => {
    test('should check specific permission', () => {
      ...
      expect(result.current.hasPermission(PERMISSIONS.ATTENDANCE_VIEW)).toBe(true);
      expect(result.current.hasPermission(PERMISSIONS.CHURCH_MEMBERS_VIEW)).toBe(true);
    });
  ...
  describe('hasAnyPermission', () => {
    test('should return true if user has any of the specified permissions', () => {
      ...
      expect(
        result.current.hasAnyPermission([PERMISSIONS.ATTENDANCE_VIEW, PERMISSIONS.USER_DELETE])
      ).toBe(true);
    });
    ...
    test('should return false if user has none of the specified permissions', () => {
      ...
      expect(
        result.current.hasAnyPermission([PERMISSIONS.USER_DELETE, PERMISSIONS.USER_CREATE])
      ).toBe(false);
    });
  });
  ...
  describe('validateAccess', () => {
    ...
    test('should return authorization failure for unauthorized user', () => {
      ...
      const validation = result.current.validateAccess(undefined, [
        'Administrator',
      ]);
