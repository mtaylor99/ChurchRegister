 ...
 * Provides methods to show and dismiss toast messages with severity levels.
 * @returns Object with toasts array, showToast, hideToast, showSuccess, showError, showWarning, showInfo
 * @example
 * const { showSuccess, showError } = useToast();
 * showSuccess('Member saved successfully');
 * showError('Failed to save member', 'Save Error');
 */
