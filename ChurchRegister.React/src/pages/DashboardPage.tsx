...
import type { TrainingAlertItem } from '@services/api';
                ...
                <CardContent sx={{ p: 3 }}>
                  ...
                  >
                    <Avatar
                      sx={{
                        bgcolor:
                          trainingAlerts.length > 0 ? '#FF9800' : '#4CAF50',
                        width: 56,
                        height: 56,
                      }}
                    >
                    ...
                    <Box
                      sx={{
                        ...
                        alignItems: 'center',
                        color:
                          trainingAlerts.length > 0 ? '#F57C00' : '#388E3C',
                        gap: 0.5,
                      }}
                    >
                  ...
                  {trainingAlerts.length > 0 ? (
                    <>
                      ...
                      <Typography
                        ...
                        sx={{ mt: 1, mb: 2 }}
                      >
                        {uniqueMemberCount === 1 ? 'person' : 'people'} with
                        expiring training
                      </Typography>
                      <Typography variant="caption" color="text.secondary">
                        {trainingAlerts.length}{' '}
                        {trainingAlerts.length === 1 ? 'item' : 'items'}{' '}
                        requiring attention
                      </Typography>
                    </>
                  ) : (
