...
import type { AuthErrorShape } from '../../utils/typeGuards';
...
export const LoginPage: React.FC = () => {
  ...
  const {
    ...
    resolver: yupResolver(
      loginSchema
    ) as unknown as import('react-hook-form').Resolver<LoginFormData>,
    defaultValues: {
      email: '',
      password: '',
      rememberMe: false,
  ...
  return (
    <Box sx={{ position: 'relative', minHeight: '100vh', width: '100%', display: 'flex', alignItems: 'center', overflow: 'hidden' }}>
      {/* Background image as fixed overlay */}
      <Box
        sx={{
          position: 'fixed',
          inset: 0,
          backgroundImage: 'url(/images/Calvary_Cross.png)',
