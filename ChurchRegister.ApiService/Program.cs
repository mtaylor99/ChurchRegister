...
// Add DbContext — SqlServer in real environments; TestWebApplicationFactory provides in-memory for Testing
...
builder.Services.AddScoped<ChurchRegister.ApiService.UseCase.ChurchMembers.ExportEnvelopeLabels.IExportEnvelopeLabelsUseCase,
...
builder.Services.AddScoped<ChurchRegister.ApiService.UseCase.Districts.ExportDistrictsMemberList.IExportDistrictsMemberListUseCase,
                           ChurchRegister.ApiService.UseCase.Districts.ExportDistrictsMemberList.ExportDistrictsMemberListUseCase>();
...
builder.Services.AddScoped<ChurchRegister.ApiService.UseCase.Contributions.GetUnmatchedTransactions.IGetUnmatchedTransactionsUseCase,
                           ChurchRegister.ApiService.UseCase.Contributions.GetUnmatchedTransactions.GetUnmatchedTransactionsUseCase>();
builder.Services.AddScoped<ChurchRegister.ApiService.UseCase.Contributions.AssignTransaction.IAssignTransactionUseCase,
...
// Configure MembershipNumbers settings
builder.Services.Configure<ChurchRegister.ApiService.Configuration.MembershipNumbersConfiguration>(
    builder.Configuration.GetSection(ChurchRegister.ApiService.Configuration.MembershipNumbersConfiguration.SectionName));
...
// Register Label PDF Service
builder.Services.AddScoped<ChurchRegister.ApiService.Services.Labels.ILabelPdfService,
                           ChurchRegister.ApiService.Services.Labels.LabelPdfService>();
...
// Register HSBC Unmatched Transaction Service
builder.Services.AddScoped<ChurchRegister.ApiService.Services.Contributions.IHsbcUnmatchedTransactionService,
                           ChurchRegister.ApiService.Services.Contributions.HsbcUnmatchedTransactionService>();
...
// Validate required configuration (after build so test environments can override config)
