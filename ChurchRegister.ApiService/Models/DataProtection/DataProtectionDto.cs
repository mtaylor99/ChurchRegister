...
/// <summary>
/// Data transfer object for complete data protection consent information
/// </summary>
public class DataProtectionDto
{
    /// <summary>
    /// Unique data protection record identifier
    /// </summary>
    public int Id { get; set; }

    /// <summary>
    /// Church member identifier this record belongs to
    /// </summary>
