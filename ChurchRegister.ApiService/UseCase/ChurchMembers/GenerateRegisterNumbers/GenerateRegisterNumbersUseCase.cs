...
public class GenerateRegisterNumbersUseCase : IGenerateRegisterNumbersUseCase
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        _logger.LogInformation(
            "Successfully generated {MemberCount} Member numbers and {NonMemberCount} Non-Member numbers for year {Year}",
            result.TotalMembersAssigned, result.TotalNonMembersAssigned, request.TargetYear);
