...
See the `Authentication` folder for complete examples of:

- Login use case with request/response
- Logout use case with response only
- GetCurrentUser use case with custom input parameter

This pattern can be replicated for other domains like Members, Events, Reports, etc.
