...
public class DistrictService : IDistrictService
{
    ...
    public async Task<List<DistrictDto>> GetAllDistrictsAsync()
    {
        ...
        foreach (var district in districts)
        {
            ...
            {
                Id = district.Id,
                Name = district.Name,                Description = district.Description,                DeaconId = district.DeaconId,
    ...
    /// <inheritdoc />
    public async Task<DistrictDto> AssignDescriptionAsync(int districtId, string? description)
    {
        var district = await _context.Districts
            .Include(d => d.Deacon)
            .Include(d => d.DistrictOfficer)
