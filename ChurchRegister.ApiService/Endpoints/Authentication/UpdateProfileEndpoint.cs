...
namespace ChurchRegister.ApiService.Endpoints.Authentication;

public class UpdateProfileEndpoint : Endpoint<Models.Authentication.UpdateProfileRequest, UserDto>
{
    ...
    public override async Task HandleAsync(Models.Authentication.UpdateProfileRequest request, CancellationToken ct)
    {
        try
        {
