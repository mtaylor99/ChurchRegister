...
public class GetPastoralCareReportEndpoint : EndpointWithoutRequest
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await Send.BytesAsync(pdfBytes, "Pastoral-Care.pdf", "application/pdf", cancellation: ct);
    }
}
...
public class GetTrainingReportEndpoint : EndpointWithoutRequest
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await Send.BytesAsync(pdfBytes, "Training.pdf", "application/pdf", cancellation: ct);
    }
}
...
public class GetRiskAssessmentsReportEndpoint : EndpointWithoutRequest
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await Send.BytesAsync(pdfBytes, "Risk-Assessments.pdf", "application/pdf", cancellation: ct);
    }
}
...
public class GetRemindersReportEndpoint : EndpointWithoutRequest
{
    ...
    public override async Task HandleAsync(CancellationToken ct)
    {
        ...
        await Send.BytesAsync(pdfBytes, "Reminders.pdf", "application/pdf", cancellation: ct);
    }
}
