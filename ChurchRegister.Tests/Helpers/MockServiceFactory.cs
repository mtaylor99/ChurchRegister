...
public static class MockServiceFactory
{
    ...
    public static Mock<IRegisterNumberService> CreateRegisterNumberService()
    {
        ...
        // Setup default behavior: return sequential register numbers for both Member and Non-Member roles
        var nextRegisterNumber = 1000;
        mock.Setup(x => x.GetNextAvailableNumberForRoleAsync(It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(() => nextRegisterNumber++);

        mock.Setup(x => x.HasBeenGeneratedForYearAsync(It.IsAny<int>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(false);
