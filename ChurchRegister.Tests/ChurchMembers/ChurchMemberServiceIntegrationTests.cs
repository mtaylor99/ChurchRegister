...
public class ChurchMemberServiceIntegrationTests : IAsyncLifetime
{
    ...
    [Fact]
    public async Task UpdateChurchMember_WithDuplicateBankReference_ReturnsError()
    {
        ...
        // Try to assign the same bank reference to our primary member
        var client = AdminClient();
        var request = BaseUpdateRequest();
        ...
        // Should fail with 400 or 409 due to uniqueness validation
